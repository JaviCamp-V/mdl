...
const ReviewDetails: React.FC<ReviewDetailsProps> = async ({ section, mediaId, mediaType }) => {
  ...
  if (section === 'overview')
    return <ReviewOverview reviews={sorted.slice(0, 2)} mediaId={mediaId} mediaType={mediaType} />;

  return <AllReviews reviews={sorted} mediaId={mediaId} mediaType={mediaType} />;
};
