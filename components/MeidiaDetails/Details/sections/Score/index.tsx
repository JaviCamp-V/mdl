...
interface ScoreProps {
  vote_average: number;
  vote_count: number;
  number_of_watchers?: number; // TODO: When implemented, remove the question mark
  number_of_reviews?: number;
}
const Score: React.FC<ScoreProps> = ({ vote_average, vote_count, number_of_reviews = 0, number_of_watchers = 0 }) => {
  return (
    <Box>
